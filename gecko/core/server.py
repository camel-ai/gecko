...
class GeckoServer:
    ...
    def __init__(
        self,
        schemas_dir: Union[str, List[str]] = "data/bfcl/openapi",
        response_model: str = "gpt-4.1-mini",
        state_model: str = "gpt-4.1-mini",
        validation_model: str = "gpt-4.1-mini",
        workers: int = 1,
    ):
        """Initialize Gecko with one or more directories containing OpenAPI schemas.
        Args:
            schemas_dir: Directory or prioritized directories containing OpenAPI schemas
            ...
            workers: Number of Gecko worker processes for health reporting
        """
        os.environ["GECKO_WORKERS"] = str(workers)
        self.app = FastAPI()
